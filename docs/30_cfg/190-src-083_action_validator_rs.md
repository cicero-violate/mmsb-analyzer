# CFG Group: src/083_action_validator.rs
...
```mermaid
flowchart TD
    matches_function_0["ENTRY"]
    matches_function_1["constraint . target () == action_name"]
    matches_function_2["EXIT"]
    matches_function_0 --> matches_function_1
    matches_function_1 --> matches_function_2
```
...
flowchart TD
    ...
    test_check_move_allowed_2["let result = check_move_allowed ('test_fn' , & PathBuf :: from ('a.rs') , & PathBuf :: fro..."]
