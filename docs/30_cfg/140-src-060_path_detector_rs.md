# CFG Group: src/060_path_detector.rs
...
flowchart TD
    ...
    test_path_detector_simple_8["let invariants = detector . detect_all (10 , 100)"]
    test_path_detector_simple_9["macro assert"]
    test_path_detector_simple_10["EXIT"]
    ...
    test_path_detector_simple_9 --> test_path_detector_simple_10
```
