# Structure Group: src/191_agent_cli.rs

## File: src/191_agent_cli.rs

- Layer(s): 191_agent_cli.rs
- Language coverage: Rust (10)
- Element types: Enum (1), Function (7), Module (1), Struct (1)
- Total elements: 10
...
- [Rust | Function] `test_load_invariants_empty` (line 0, priv)
  - Signature: `# [test] fn test_load_invariants_empty () { let temp_path = std :: env :: temp_dir () . join ("test_invariants.json")...`
  - Calls: join, std::env::temp_dir, unwrap, std::fs::write, load_invariants, std::fs::remove_file
