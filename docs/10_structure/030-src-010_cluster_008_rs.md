...
- Language coverage: Rust (21)
- Element types: Function (20), Struct (1)
- Total elements: 21
...
- [Rust | Function] `detect_layer_violations` (line 0, pub)
  - Signature: `pub fn detect_layer_violations (graph : & DiGraph < PathBuf , () > , file_layers : & HashMap < PathBuf , String > ,) ...`
  - Calls: Vec::new, edge_references, source, target, unwrap_or_else, cloned, get, to_string, unwrap_or_else, cloned, get, to_string, layer_prefix_value, layer_prefix_value, push, clone, clone
